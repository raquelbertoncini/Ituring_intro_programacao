...
//Exercício 1:
total = 0
for (let r of receita) {
     total = total + r.valor
 }
 console.log('Valor total vendas:' +total)

//Exercício 2:
soma = 0
for (let g of receita) {
    soma = soma +g.gorjeta
}
console.log('Gorjeta total:' +soma)
console.log('Total de vendas incluindo gorjeta R$', total+soma)

//Exercício 3:
let abaixo50 = 0
for (let venda of receita) {
    if (venda.valor < 50) {
        abaixo50 = abaixo50 + 1
    }
}
console.log('Vendas abaixo de 50:', abaixo50)
